...
import {MockV3Aggregator} from "./MockV3Aggregator.sol"; //new line
...
contract MockMoreDebtDsc is ERC20Burnable, Ownable {
    ...
    address mockAggregator; //new line
    ...
    */
    constructor(address _mockAggregator) ERC20("DecentralizedStableCoin", "DSC") {
        //modified
        mockAggregator = _mockAggregator; //new line
    }

    function burn(uint256 _amount) public override onlyOwner {
        MockV3Aggregator(mockAggregator).updateAnswer(0); //new line, crashing the price of the COLLATERAL
